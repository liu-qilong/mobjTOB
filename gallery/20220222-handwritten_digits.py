...
class SceneMLP(MovingCameraScene):
    ...
    def construct(self):
        ...
        layer1 = neuralwork_irregular.SingleLayer(self, 8, 5, 0.5*LEFT, 1)
        layer2 = neuralwork_irregular.Overlayer(self, layer1, 6, 1)

        labels = ['0', '1', '2', '3', '4', '....']
        labels.reverse()
        layer2.add_output_labels(labels, font_size=35)

        img_and_rec.next_to(layer1.mobj, LEFT)
        self.add(img_and_rec, layer1.mobj, layer2.mobj)

        layer1.image_input(img)
        layer2.image_input(img)
...
class SceneCNN(MovingCameraScene):
    ...
    def construct(self):
        ...
        single = neuralwork_irregular.SingleLayer(self, 8, 5, RIGHT, 1)
        ...
        conv_show_single = neuralwork_irregular.Convolution(self, arr_A_single, arr_B_single,
        ...
        img_crop = imgwork_irregular.PartialShow(self, img, zoom_rate=30, zoom_pos=DOWN + RIGHT, show_pos=UP)
        img_crop.show()
        ...
        conv_show = neuralwork_irregular.Convolution(self, arr_A, arr_B,
